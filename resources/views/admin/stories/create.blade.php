<x-admin-layout>
    <x-slot name="header">Add New Story</x-slot>
                    ...
                    <form action="{{ route('admin.stories.store') }}" method="POST">
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="title" id="title" required value="{{ old('title') }}"
                                       class="form-control" placeholder="Enter English Title">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="content" id="content" rows="12" required
                                      class="form-control" style="font-size: 1rem; line-height: 1.7;"
                        ...
                        <div class="mb-4">
                            <label for="content_ml" class="form-label-sm d-block mb-1">Content (ML) <span class="text-muted fw-normal">— optional</span></label>
                            <textarea name="content_ml" id="content_ml" rows="8"
                                      class="form-control" style="font-size: 1rem; line-height: 1.7;"
                                      placeholder="ഒരിക്കൽ ഒരിടത്ത്...">{{ old('content_ml') }}</textarea>
                        </div>

                        <div class="d-flex justify-content-end gap-3 pt-3 border-top">
                            <a href="{{ route('admin.stories.index') }}" class="btn btn-outline-secondary fw-bold">Cancel</a>
